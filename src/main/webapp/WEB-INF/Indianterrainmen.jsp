   ...
   <tbody>
    <tr bgcolor="#141821">
     ...
     <td align="center" width="15%">
      <form name="men" method="get" action=" /Indianterrain" >
      	<input class="button1" type="Submit" value="Home">
      </form>
          <td align="center" width="15%">
      <form name="men" method="get" action=" /IndianterrainMen" >
      	<input class="button1" type="Submit" value="Men">
      </form>
     <td align="center" width="15%">
      <form name="men" method="get" action=" /IndianterrainWomen" >
      	<input class="button2" type="Submit" value="Women">
      </form>
     <td align="center" width="15%">
      <form name="men" method="get" action=" /IndianterrainKids" >
      	<input class="button3" type="Submit" value="Kids">
      </form>
     <td align="center" width="15%">
     <form name="men" method="get" action=" /IndianterrainBelt" >
              ...
              <table width=1000 border=1>
                ...
                <td>
                           ...
                           Available: ${p.quantity} <br> <br>
                                  <form method="GET" action=" /purchaseTshirt">

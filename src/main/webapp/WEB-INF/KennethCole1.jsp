...
<title>Welcome to Kenneth Cole !!!</title>
...
<body>
	<div id="logo">
		<h1>
			<a href="#" class="icon icon-group"><span>Kenneth Cole</span></a>
		</h1>
	</div>
	<div id="header">
		<div id="menu" class="container">
			<ul>
				<li class="current_page_item"><a href="/" accesskey="1"
					title="">Homepage</a></li>
				<li><a href="http://www.kennethcole.com/shop/index.jsp?categoryId=24307366" accesskey="3" title="">Main Site</a></li>
				<!-- <li><a href="http://en.wikipedia.org/wiki/Kenneth_Cole_(designer)" accesskey="3" title="">Wikipedia Page</a></li>
				<li><a href="http://www.kennethcole.com/shop/index.jsp?categoryId=23805596&clickid=topnav_logo_img&om=PS-S-text:Google:Kenneth%20Cole%20Outlet:txt:::Outlet%20General%20-%20Broad:{kenneth%20cole%20coupon}&gclid=CK_xvN-m-L0CFUoV7Aod4AgA_A" accesskey="5" title="">Contact Us</a></li>
			 -->
			</ul>
		</div>
	</div>
	...
	<div id="header">
		<div id="menu" class="container">
			<ul>
				...
				<li>
					<form name="men" method="get" action="/KennethWomen">
						<input class="button2" type="Submit" value="Women">
					</form>
				</li>
				<li>
					<form name="men" method="get" action="/KennethKids">

		...
		<div align=center>
			<table WIDTH="60%">
				<tr height="25">
					...
					<td>
						<div>
							<form method="GET" name="Men" action=" /nikeMen">
					...
					<td>
						<div>
							<form method="GET" name="Women" action=" /nikeWomen">
					...
					<td>
						<div>
							<form method="GET" name="Kids" action=" /nikeKids">
					...
					<td>
						<div>
							<form method="GET" name="Featured" action=" /nikeFeatured">

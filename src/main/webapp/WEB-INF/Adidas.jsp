...
<body>
		...
		<div id="menu" class="container">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1"
					title="">Homepage</a></li>
				<li><a href=" /" accesskey="3" title="">Main Site</a></li>
	...
	<div id="header">
		<div id="menu" class="container">
			<ul>
				<li>
					<form name="men" method="get" action=" /AdidasMen">
						<input class="button1" type="Submit" value="Men">
					</form>
				</li>
				<li>
					<form name="men" method="get" action=" /AdidasWomen">
						<input class="button2" type="Submit" value="Women">
					</form>
				</li>
				<li>
					<form name="men" method="get" action=" /AdidasKids">

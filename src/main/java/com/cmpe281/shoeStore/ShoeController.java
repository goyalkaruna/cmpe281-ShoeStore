...
public class ShoeController {
    ...
    @Autowired private ShoeDAO shoeDAO;  
...
//    {
//    	List<Shoe> nikeMen = tshirtDAO.NikeTshirtMen();
...
//    
    ...
    public String purchaseShoe(Model model,@RequestParam("product_id") String product_id) 
    {
    	System.out.println(product_id);
    	List <Shoe> myShoe = shoeDAO.productbyId(product_id);
		model.addAttribute("myShoe", myShoe);
    	return "purchase";
    }
    ...
    public String thankYou(Model model,@RequestParam("product_id") String product_id, @RequestParam("unit") int unit) 
    {
    	...
    	String Status = shoeDAO.thankYou(product_id, unit);
...
//		List<Shoe> pumaTshirts = tshirtDAO.findPumaTshirt();
...
//		
    // ========================= Adidas Controller ================================
		...
		{
			List<Shoe> adidasMen = shoeDAO.adidasShoesMen();
		...
		{
			List<Shoe> adidasWomen = shoeDAO.adidasShoesWomen();
		...
		{
			List<Shoe> adidasKids = shoeDAO.adidasShoesKids();
...
//		    }
		...
		@RequestMapping("/KennethCole")
		public String KennethCole(Model model)
		{
			
			return "KennethCole";
		}
		
		@RequestMapping(value= "/KennethMen", method = RequestMethod.GET)
		public String KennethColemen(Model model)
		{
			List<Shoe> kennethMen = shoeDAO.kennethColeShoesMen();
			model.addAttribute("kennethMen", kennethMen);
			
			return  "KennethMen";
		}
		
		@RequestMapping(value= "/KennethWomen", method = RequestMethod.GET)
		public String KennethColewomen(Model model)
		{
			List<Shoe> kennethWomen = shoeDAO.kennethColeShoesWomen();
			model.addAttribute("kennethWomen", kennethWomen);
			
			return "KennethWomen";
		}
		
		@RequestMapping(value= "/KennethKids", method = RequestMethod.GET)
		public String KennethColekids(Model model)
		{
			List<Shoe> kennethKids = shoeDAO.kennethColeShoesKids();
			model.addAttribute("kennethKids", kennethKids);
